...
function (_Component) {
  ...
  function Robots(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleClick", function (robotId) {
      ...
      Router.push({
        pathname: "/robot?id=".concat(selectedRobot.id),
        query: {
          robot: selectedRobot
        }
      });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderRobotsList", function () {
      return _this.state.robots.map(function (robot) {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
          ...
          __self: this
        }, robot.name), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(next_link__WEBPACK_IMPORTED_MODULE_1___default.a, {
          href: "robot?id=".concat(robot.id, "name=").concat(robot.name, "?email=").concat(robot.email, "?city=").concat(robot.addresscity, "?catchPhrase=").concat(robot.companycatchPhrase),
          __source: {
            fileName: _jsxFileName,
            lineNumber: 48
          },
  ...
  _createClass(Robots, [{
    ...
    value: function componentDidMount() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get("https://jsonplaceholder.typicode.com/users").then(function (response) {
...
//# sourceMappingURL=robots.js.25d824eb00942de282a0.hot-update.js.map